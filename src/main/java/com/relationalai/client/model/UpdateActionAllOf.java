...
public class UpdateActionAllOf {
  ...
  public UpdateActionAllOf delta(List<PairAnyValueAnyValue> delta) {
    
    this.delta = delta;
    return this;
  }

  public UpdateActionAllOf addDeltaItem(PairAnyValueAnyValue deltaItem) {
    if (this.delta == null) {
  ...
  **/
  ...
  public UpdateActionAllOf rel(RelKey rel) {
  ...
  **/
  ...
  public UpdateActionAllOf updates(List<PairAnyValueAnyValue> updates) {
    
    this.updates = updates;
    return this;
  }

  public UpdateActionAllOf addUpdatesItem(PairAnyValueAnyValue updatesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UpdateActionAllOf updateActionAllOf = (UpdateActionAllOf) o;
    return Objects.equals(this.delta, updateActionAllOf.delta) &&
        Objects.equals(this.rel, updateActionAllOf.rel) &&
        Objects.equals(this.updates, updateActionAllOf.updates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(delta, rel, updates);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateActionAllOf {\n");
