...
import com.relationalai.cloudclient.model.GetAccountCreditsResponse;
import com.relationalai.cloudclient.model.ListComputeEventsResponse;
...
public class DefaultApi {
    ...
    /**
     * Build call for accountCreditsGet
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Account Credits </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call accountCreditsGetCall(String period, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/account/credits";
    ...
    private okhttp3.Call accountCreditsGetValidateBeforeCall(String period, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = accountCreditsGetCall(period, _callback);
        return localVarCall;
     ...
     * 
     * @param period  (optional)
     * @return GetAccountCreditsResponse
     ...
     */
    public GetAccountCreditsResponse accountCreditsGet(String period) throws ApiException {
        ApiResponse<GetAccountCreditsResponse> localVarResp = accountCreditsGetWithHttpInfo(period);
     ...
     * 
     * @param period  (optional)
     * @return ApiResponse&lt;GetAccountCreditsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetAccountCreditsResponse> accountCreditsGetWithHttpInfo(String period) throws ApiException {
        okhttp3.Call localVarCall = accountCreditsGetValidateBeforeCall(period, null);
        Type localVarReturnType = new TypeToken<GetAccountCreditsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get account credits consumption (asynchronously)
     * 
     * @param period  (optional)
     ...
     */
    public okhttp3.Call accountCreditsGetAsync(String period, final ApiCallback<GetAccountCreditsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = accountCreditsGetValidateBeforeCall(period, _callback);
        Type localVarReturnType = new TypeToken<GetAccountCreditsResponse>(){}.getType();
     ...
     */
    public okhttp3.Call computeGetCall(List<String> id, List<String> name, List<String> size, List<String> state, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
     ...
     */
    public ListComputesResponseProtocol computeGet(List<String> id, List<String> name, List<String> size, List<String> state) throws ApiException {
        ApiResponse<ListComputesResponseProtocol> localVarResp = computeGetWithHttpInfo(id, name, size, state);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListComputesResponseProtocol> computeGetWithHttpInfo(List<String> id, List<String> name, List<String> size, List<String> state) throws ApiException {
        okhttp3.Call localVarCall = computeGetValidateBeforeCall(id, name, size, state, null);
     ...
     */
    public okhttp3.Call computeGetAsync(List<String> id, List<String> name, List<String> size, List<String> state, final ApiCallback<ListComputesResponseProtocol> _callback) throws ApiException {

        okhttp3.Call localVarCall = computeGetValidateBeforeCall(id, name, size, state, _callback);
        Type localVarReturnType = new TypeToken<ListComputesResponseProtocol>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call databaseGetCall(List<String> id, List<String> name, List<String> state, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call databaseGetValidateBeforeCall(List<String> id, List<String> name, List<String> state, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = databaseGetCall(id, name, state, _callback);
        return localVarCall;
     ...
     */
    public ListDatabasesResponseProtocol databaseGet(List<String> id, List<String> name, List<String> state) throws ApiException {
        ApiResponse<ListDatabasesResponseProtocol> localVarResp = databaseGetWithHttpInfo(id, name, state);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListDatabasesResponseProtocol> databaseGetWithHttpInfo(List<String> id, List<String> name, List<String> state) throws ApiException {
        okhttp3.Call localVarCall = databaseGetValidateBeforeCall(id, name, state, null);
     ...
     */
    public okhttp3.Call databaseGetAsync(List<String> id, List<String> name, List<String> state, final ApiCallback<ListDatabasesResponseProtocol> _callback) throws ApiException {

        okhttp3.Call localVarCall = databaseGetValidateBeforeCall(id, name, state, _callback);
        Type localVarReturnType = new TypeToken<ListDatabasesResponseProtocol>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for listComputeEvents
     * @param computeId  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Events </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listComputeEventsCall(String computeId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/compute/{computeId}/events"
            .replaceAll("\\{" + "computeId" + "\\}", localVarApiClient.escapeString(computeId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listComputeEventsValidateBeforeCall(String computeId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'computeId' is set
        if (computeId == null) {
            throw new ApiException("Missing the required parameter 'computeId' when calling listComputeEvents(Async)");
        }
        

        okhttp3.Call localVarCall = listComputeEventsCall(computeId, _callback);
        return localVarCall;
     ...
     * 
     * @param computeId  (required)
     * @return ListComputeEventsResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
    ...
    public ListComputeEventsResponse listComputeEvents(String computeId) throws ApiException {
        ApiResponse<ListComputeEventsResponse> localVarResp = listComputeEventsWithHttpInfo(computeId);
        return localVarResp.getData();
    }
     ...
     * 
     * @param computeId  (required)
     * @return ApiResponse&lt;ListComputeEventsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ListComputeEventsResponse> listComputeEventsWithHttpInfo(String computeId) throws ApiException {
        okhttp3.Call localVarCall = listComputeEventsValidateBeforeCall(computeId, null);
        Type localVarReturnType = new TypeToken<ListComputeEventsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * List compute events (asynchronously)
     * 
     * @param computeId  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call listComputeEventsAsync(String computeId, final ApiCallback<ListComputeEventsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listComputeEventsValidateBeforeCall(computeId, _callback);
        Type localVarReturnType = new TypeToken<ListComputeEventsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
