...
public class HttpResponseHandler extends SimpleChannelInboundHandler<FullHttpResponse>
{
    ...
    private final Map<Integer, FullHttpResponse> streamIdResponseMap;
    ...
    public FullHttpResponse getHttpResponse(int streamId)
    {
        LOGGER.debug("HttpResponseHandler.getHttpResponse: " + streamId);
    ...
    {
        LOGGER.debug("HttpResponseHandler.putHttpResponse: " + streamId);
    ...
    {
        Iterator<Entry<Integer, Entry<ChannelFuture, ChannelPromise>>> itr =
        ...
        while (itr.hasNext())
        {
            ...
            LOGGER.debug("---Stream id: " + entry.getKey() + " received---");
            itr.remove();
        }
    }
